...
<body>
    <div class="jenislapangan">
        <h1>Lapangan Basket</h1>
    </div>

    <div class="jadwal">
        <div class="gambarlapangan">
            <img src="../gambar/basket jadwal.png" alt="lapangan basket">
        </div>
        ...
        <div class="keterangan">
            ...
            <div class="keteranganbawah">
                <h3>Lapangan Basket Sutoyo</h3>
                <a href="bookingbasket.php" class="booking-button">Booking</a>
            </div>
        </div>
    </div>
    ...
    <script src="../js/jadwalbasket.js"></script>
</body>
</html>