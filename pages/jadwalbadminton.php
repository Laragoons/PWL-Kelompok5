...
<body>
    ...
    <div class="jadwal">
        <div class="gambarlapangan">
            <img src="../gambar/badminton jadwal.png" alt="lapangan badminton">
        </div>
        ...
        <div class="keterangan">
            ...
            <div class="keteranganbawah">
                <h3>Lapangan Badminton Sutoyo</h3>
                <a href="bookingbadmin.php" class="booking-button">Booking</a>
            </div>
        </div>
    </div>
    ...
    <script src="../js/jadwalbadminton.js"></script>
</body>
</html>