...
<body>
    ...
    <main class="content-container">
        <h1 class="page-title">Lapangan Badminton</h1>

        <div class="futsal-court-image">
            <img src="../gambar/badminbooking.png" alt="Lapangan Badminton">
        </div>

        <form action="konfirmasi.php" method="POST" class="booking-form">

            <input type="hidden" name="court_id" value="3"> <div class="form-row">
